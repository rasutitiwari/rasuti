...
const HeroSection = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroImage} alt="Biotechnology Research Background" className="w-full h-full object-cover" />
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="animate-fade-in">
            <div className="font-heading text-3xl md:text-4xl font-bold mb-4 text-foreground">
              RASUTI
            </div>
          ...
          <div className="animate-scale-in flex flex-col sm:flex-row gap-4 justify-center items-center mb-12" style={{
          animationDelay: '0.4s',
          animationFillMode: 'both'
        }}>
          ...
          {/* Statistics */}
          <div className="animate-fade-in grid grid-cols-3 gap-8 max-w-2xl mx-auto mb-12" style={{
          animationDelay: '0.6s',
          animationFillMode: 'both'
        }}>
